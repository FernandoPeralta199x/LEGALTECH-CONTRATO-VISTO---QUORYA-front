...
const otherMap: Record<string, Cfg> = {
  ...
  submitted:                { label: "Registrado",   dot: "bg-blue-500",               tone: "cv-badge-blue" },
  ...
  processamento_documental: { label: "Em preparação",        dot: "bg-purple-500 animate-ping", tone: "cv-badge-blue" },
  analise_contratual:       { label: "Análise contratual",           dot: "bg-violet-500 animate-ping", tone: "cv-badge-blue" },
  ...
  processing:               { label: "Em preparação",        dot: "bg-purple-500 animate-ping", tone: "cv-badge-blue" },
  review:                   { label: "Revisão",                 dot: "bg-yellow-500 animate-pulse", tone: "cv-badge-orange" },
  approved:                 { label: "Validado",         dot: "bg-teal-500",               tone: "cv-badge-teal" },
  ...
  uploaded:                 { label: "Anexado",             dot: "bg-blue-500",               tone: "cv-badge-blue" },
  processed:                { label: "Processado",        dot: "bg-teal-500",               tone: "cv-badge-teal" },
  done:                     { label: "Processado",        dot: "bg-teal-500",               tone: "cv-badge-teal" },
