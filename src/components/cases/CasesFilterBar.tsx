...
/** Barra de busca + filtro de status + contador. Presentacional. O debounce e o reset de
 *  página do campo de busca vivem no hook useCasesList; o reset de página do filtro é feito
 *  no handler `onStatusChange` (mantido na página, no MESMO update → 1 único fetch). */
