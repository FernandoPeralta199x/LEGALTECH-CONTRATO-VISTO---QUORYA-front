...
/** Formulário de caso rápido (local). Presentacional: só renderiza os campos e dispara
 *  onFieldChange/onSubmit/onCancel. A validação (validateCaseForm), a montagem do payload
 *  CaseCreate e o createCase permanecem no handleSubmit da página. Extraído de cases/page
 *  (fe-struct-02). Os valores técnicos (case_type/product/priority) são intactos. */
