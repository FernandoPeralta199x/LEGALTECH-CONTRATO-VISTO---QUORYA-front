          ...
          <div className="mb-6 flex items-start gap-3 rounded-[var(--r)] border border-[rgba(96,165,250,0.22)] bg-[var(--blue-dim)] p-4">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-1 text-xs leading-5 text-[var(--text2)]">
                Visão Geral, Vendas, Serviços, Clientes, Gastos com APIs, Tributos e Notas e
                Relatórios são{" "}
                ...
                líquida, margem, atraso) e as abas de Pagamentos/Recebíveis/Reembolsos aparecem
                vazias até serem integradas nas próximas fases.
              </p>
            </div>
          </div>
